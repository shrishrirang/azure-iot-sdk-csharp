...
//            using DpsClient.SecurityProvider security = await CreateDpsSecurityProviderFromNameAsync(
//                    attestationType,
//                    enrollmentType,
//                    groupId,
//                    reprovisionPolicy,
...
//            using SecurityProvider security = await CreateDpsSecurityProviderFromNameAsync(
//                    attestationType,
//                    enrollmentType,
//                    groupId,
//                    null,
...
//        {
//            using ProvisioningTransportHandler transport = CreateTransportHandlerFromName(transportProtocol);
//            using SecurityProvider security = await CreateDpsSecurityProviderFromNameAsync(attestationType, enrollmentType, groupId, null, AllocationPolicy.Hashed, null, null).ConfigureAwait(false);
//            var provClient = ProvisioningDeviceClient.Create(
//                s_globalDeviceEndpoint,
//                InvalidIdScope,
//                security,
...
//        [System.Diagnostics.CodeAnalysis.SuppressMessage("Reliability", "CA2000:Dispose objects before losing scope", Justification = "Up to caller to dispose.")]
//        private async Task<DpsClient.SecurityProvider> CreateDpsSecurityProviderFromNameAsync(
//            AttestationMechanismType attestationType,
//            EnrollmentType? enrollmentType,
//            string groupId,
//            ReprovisionPolicy reprovisionPolicy,
...
//        {
//            _verboseLog.WriteLine($"{nameof(CreateDpsSecurityProviderFromNameAsync)}({attestationType})");
...
//        [System.Diagnostics.CodeAnalysis.SuppressMessage("Reliability", "CA2000:Dispose objects before losing scope", Justification = "Up to caller to dispose.")]
//        private async Task<Client.SecurityProvider> CreateDeviceSecurityProviderFromNameAsync(
//            AttestationMechanismType attestationType,
//            EnrollmentType? enrollmentType,
//            string groupId,
//            ReprovisionPolicy reprovisionPolicy,
